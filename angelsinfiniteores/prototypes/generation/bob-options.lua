if mods["bobores"] then
  if bobmods.ores.settings.UnsortedGemOre == true then
    ...
    bobmods.lib.resource.add_result("infinite-gem-ore", {
      name = "diamond-ore",
  ...
  if bobmods.ores.settings.GemsFromOtherOres == true then
    bobmods.lib.resource.add_result("infinite-coal", {
      name = "diamond-ore",
      probability = bobmods.ores.settings.GemProbability * bobmods.gems.DiamondRatio
    })

    bobmods.lib.resource.add_result("infinite-quartz", {
      name = "emerald-ore",
    ...
    bobmods.lib.resource.add_result("infinite-bauxite-ore", {
      name = "ruby-ore",
  ...
  if bobmods.ores.settings.NickelGivesCobalt == true then
    ...
    if bobmods.ores.nickel.enabled then
      bobmods.lib.resource.add_result("infinite-nickel-ore", {
        name = "cobalt-ore",
