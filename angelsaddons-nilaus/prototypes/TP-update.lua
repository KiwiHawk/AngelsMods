if mods["angelsbioprocessing"] and data.raw.item["solid-paper"] then
  ...
  data.raw.item["solid-paper"].icon =
    "__angelsaddons-nilaus__/graphics/icons/nilaus-paper.png"
  ...
  data.raw.item["solid-paper"].localised_name =
    {
      ...
      data.raw.item["solid-paper"].localised_name or {"item-name.solid-paper"}
    }
  data.raw.item["solid-paper"].localised_description =
    {"item-description.nilaus-paper"}

  -- replace recipe icons
  data.raw.recipe["paper-bleaching-1"].icons[1].icon =
    data.raw.item["solid-paper"].icon
  data.raw.recipe["paper-bleaching-1"].icons[1].icon_size =
    data.raw.item["solid-paper"].icon_size
  data.raw.recipe["paper-bleaching-1"].icons[1].scale =
    32 / data.raw.item["solid-paper"].icon_size
  data.raw.recipe["paper-bleaching-2"].icons[1].icon =
    data.raw.item["solid-paper"].icon
  data.raw.recipe["paper-bleaching-2"].icons[1].icon_size =
    data.raw.item["solid-paper"].icon_size
  data.raw.recipe["paper-bleaching-2"].icons[1].scale =
    32 / data.raw.item["solid-paper"].icon_size
  data.raw.recipe["paper-bleaching-3"].icons[1].icon =
    data.raw.item["solid-paper"].icon
  data.raw.recipe["paper-bleaching-3"].icons[1].icon_size =
    data.raw.item["solid-paper"].icon_size
  data.raw.recipe["paper-bleaching-3"].icons[1].scale =
    32 / data.raw.item["solid-paper"].icon_size

  -- replace technology icons
  data.raw.technology["bio-paper-1"].icon = data.raw.item["solid-paper"].icon
  data.raw.technology["bio-paper-1"].icon_size =
    data.raw.item["solid-paper"].icon_size
  ...
  data.raw.technology["bio-paper-2"].icon_size =
    data.raw.item["solid-paper"].icon_size
  ...
  data.raw.technology["bio-paper-3"].icon_size =
    data.raw.item["solid-paper"].icon_size
  ...
  compilatron.localised_name =
    {string.format("entity-name.%s", compilatron.name)}
