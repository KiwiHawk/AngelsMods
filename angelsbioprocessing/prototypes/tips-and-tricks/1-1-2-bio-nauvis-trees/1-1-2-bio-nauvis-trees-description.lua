...
local description = {"", {"tips-and-tricks-description.nauvis-trees"}}
...
table.insert(items, {
  "",
  {"tips-and-tricks-sub.trees-desert", moisture_rate["desert"]},
  "\n"
})
table.insert(items, tnt.get_item_from_name("temperate-tree"))
table.insert(items, {
  "",
  {"tips-and-tricks-sub.trees-temperate", moisture_rate["temperate"]},
  "\n"
})
table.insert(items, tnt.get_item_from_name("swamp-tree"))
table.insert(items, {
  "",
  {"tips-and-tricks-sub.trees-swamp", moisture_rate["swamp"]},
  "\n"
})
