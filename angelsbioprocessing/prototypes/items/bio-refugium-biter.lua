...
-----------------------------------------------------------------------------
  ...
  icons = {{icon = "__angelsbioprocessing__/graphics/icons/biter-small.png"}, {
  ...
  icons = {{icon = "__angelsbioprocessing__/graphics/icons/biter-medium.png"}, {
    icon = "__angelsbioprocessing__/graphics/icons/biter-crown.png",
    icon_size = 15,
    scale = 0.45,
    shift = {8, -11}
  ...
  icons = {{icon = "__angelsbioprocessing__/graphics/icons/biter-big.png"}, {
    icon = "__angelsbioprocessing__/graphics/icons/biter-crown.png",
    icon_size = 15,
    scale = 0.5,
    shift = {9, -12}
