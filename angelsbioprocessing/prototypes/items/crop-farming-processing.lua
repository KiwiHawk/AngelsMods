...
--[[{
  ...
  },]] --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255}, --{r=184/255, g=171/255, b=28/255},
  type = "item",
  name = "solid-beans",
  ...
  icons = AF.create_viscous_liquid_fluid_icon(nil, {
    {214, 135, 010},
    nil,
    {239, 168, 044}
  }),
  ...
  max_temperature = 100,
  heat_capacity = "1KJ",
  base_color = AF.fluid_color("C2H6O"),
  flow_color = AF.flow_color("C2H6O")
}, {
  type = "fluid",
  ...
  max_temperature = 100,
  heat_capacity = "1KJ",
  base_color = AF.fluid_color("C2H4O"),
  flow_color = AF.flow_color("C2H4O")
}, {
  type = "fluid",
  ...
  icons = AF.create_liquid_fluid_icon(
    {
      "__angelsbioprocessing__/graphics/icons/molecule-acetic-anhydride.png",
      72
    },
    "COH"
  ),
  ...
  max_temperature = 100,
  heat_capacity = "1KJ",
  base_color = AF.fluid_color("C4H6O3"),
  flow_color = AF.flow_color("C4H6O3")
}, {
  type = "fluid",
  ...
  icons = AF.create_liquid_fluid_icon(
    {
      "__angelsbioprocessing__/graphics/icons/molecule-cellulose-acetate.png",
      72
    },
    "COH"
  ),
  ...
  max_temperature = 100,
  heat_capacity = "1KJ",
  base_color = AF.fluid_color("C4H14O13"),
  flow_color = AF.flow_color("C4H14O13")
}, {
  type = "fluid",
  ...
  max_temperature = 100,
  heat_capacity = "1KJ",
  base_color = AF.fluid_color("C3H6O2"),
  flow_color = AF.flow_color("C3H6O2")
}})