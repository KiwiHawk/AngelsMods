data:extend({{
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-processing-brown"},
  effects = {{
    type = "unlock-recipe",
    recipe = "wood-pellets"
  }, {
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-wood-processing-2", "angels-coal-processing-3"},
  effects = {{
    type = "unlock-recipe",
    recipe = "wood-bricks"
  }},
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-wood-processing", "bio-farm-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-2", "bio-processing-crystal-shard-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-1", "bio-fermentation", "resins"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-temperate-1", "bio-farm-alien"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-temperate-2", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-1", "bio-nutrient-paste", "plastics"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-swamp-1", "bio-farm-alien"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-swamp-2", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"rubbers", "bio-arboretum-1", "bio-nutrient-paste"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-desert-1", "bio-farm-alien"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-arboretum-desert-2", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-paper-2", "chlorine-processing-3"},
  effects = {{
    type = "unlock-recipe",
