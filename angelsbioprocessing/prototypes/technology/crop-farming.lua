...
--}
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-farm-1", "bio-paper-1", "logistic-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-farm-alien", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"gardens", "water-washing-1"},
  effects = {{
    type = "unlock-recipe",
    recipe = "crop-farm"
  }, {
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-temperate-farm"},
  effects = {{
    type = "unlock-recipe",
    recipe = "temperate-4"
  }, {
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-farm-1", "gas-processing"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-farm-1", "slag-processing-1", "angels-oil-processing"},
  effects = {{
    type = "unlock-recipe",
    recipe = "bio-press"
  }, {
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-pressing-1", "slag-processing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-pressing-fish-1", "bio-pressing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-farm-1", "angels-sulfur-processing-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-fermentation", "bio-nutrient-paste", "plastics"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-plastic-1", "chemical-science-pack"},
  effects = {{
    type = "unlock-recipe",
