...
--"bio-refugium-hatchery",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-processing-alien-2"},
  effects = {},
  unit = {
    count = 50,
    ingredients = {{
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-refugium-fish-1", "geode-processing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-processing-crystal-shard-1", "bio-refugium-biter-3"},
  effects = {{
    type = "unlock-recipe",
