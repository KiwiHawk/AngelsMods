...
-- BUTCHERY
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-nutrient-paste"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-refugium-puffer-1", "angels-advanced-chemistry-3"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-refugium-puffer-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-refugium-puffer-3", "production-science-pack"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-refugium-biter-1", "bio-processing-crystal-shard-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  order = "c-a",
  prerequisites = {"bio-refugium-biter-2", "bio-refugium-puffer-4"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 160,
  order = "c-a",
  prerequisites = {"bio-refugium-fish-1"},
  effects = {{
    type = "unlock-recipe",
    recipe = "bio-butchery"
  }, {
  ...
  icon_size = 160,
  order = "c-a",
  prerequisites = {"bio-refugium-butchery-1", "bio-refugium-hatchery"},
  effects = {{
    type = "unlock-recipe",
