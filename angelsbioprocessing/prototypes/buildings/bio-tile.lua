local pollution_absorption_per_second =
  data.raw["tile"]["out-of-map"].pollution_absorption_per_second * settings.startup["angels-bio-tile-pollution-absorbtion-multiplier"].value
data:extend({{
--ageing = 0,
  type = "item",
  name = "bio-tile",
  localised_description = {
    "item-description.bio-tile",
