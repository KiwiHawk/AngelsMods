data:extend({{ --emissions_per_tick = -0.0001, -- {r = 0.2, g = 0.2, b = 0.8},
--tile_restriction = {"grass-1", "grass-2", "grass-3", "grass-4", "dry-dirt"}, --emissions_per_tick = -0.0001, -- {r = 0.2, g = 0.2, b = 0.8},
--tile_restriction = {"dirt-1", "dirt-2", "dirt-3", "dirt-4", "dirt-5", "dirt-6", "dirt-7"}, --emissions_per_tick = -0.0001, -- {r = 0.2, g = 0.2, b = 0.8},
