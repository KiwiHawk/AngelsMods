...
---------------------------------------------------------------------------
  ...
  icons = AF.create_liquid_recipe_icon(nil, {
    {194, 227, 091},
    {184, 239, 000},
    {156, 207, 000}
  }),
  ...
  always_show_products = true,
  icons = AF.create_viscous_liquid_filtering_recipe_icon("coal", {
    {200, 113, 048},
    {191, 155, 037},
    {241, 155, 057, 0.8},
    {244, 191, 015, 0.8}
  ...
  always_show_products = true,
  icons = AF.create_viscous_liquid_filtering_recipe_icon("ceramic", {
    {200, 113, 048},
    {191, 155, 037},
    {241, 155, 057, 0.8},
    {244, 191, 015, 0.8}
  ...
  icons = AF.create_liquid_recipe_icon(
    {"liquid-fermentation-raw", "lubricant"},
  ...
  always_show_products = true,
  icons = AF.create_liquid_recipe_icon(
    {"liquid-fermentation-raw", "liquid-mineral-oil"},
    {{244, 191, 015}, {214, 168, 029}, {191, 155, 037}}
  ),
