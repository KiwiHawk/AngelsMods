data:extend({{
--TEMPERATE -- Wheathon -- Corn
--primary = {r = 190 / 255, g = 190 / 255, b = 190 / 255, a = 1},  -- Tianaton -- Tianaton -- Celluloce fiber -- Okarinome -- Leafs -- Quillnoa -- Pips -- Kendallion -- Corn
--DESERT
--primary = {r = 240 / 255, g = 157 / 255, b = 14 / 255, a = 1}, -- Binafran -- Binafran -- Beans
--primary = {r = 79 / 255, g = 39 / 255, b = 34 / 255, a = 1}, --Primedeadelion --Primedeadelion -- Corn
--primary = {r = 130 / 255, g = 106 / 255, b = 49 / 255, a = 1}, -- Nilaubergine -- Nilaubergine -- Pips
--primary = {r = 212 / 255, g = 95 / 255, b = 0 / 255, a = 1}, -- Zelosquash -- Zelosquash -- Fruits -- Arumbiphila -- Corn
--SWAMP -- Elendilomone -- Nuts
--primary = {r = 53 / 255, g = 71 / 255, b = 19 / 255, a = 1}, -- Zombieecalyptus -- Zombieecalyptus -- Beans -- Saundsrcress -- Leafs
--primary = {r = 119 / 255, g = 79 / 255, b = 63 / 255, a = 1}, -- Nexeflax -- Nexeflax -- Leafs -- Mushredtato -- Pips
  type = "recipe",
