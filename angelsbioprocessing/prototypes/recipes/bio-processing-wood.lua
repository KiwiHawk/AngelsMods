...
--icon_size = 32,
--icon_size = 32,
--icon_size = 32, -- order a[wood]-a[manual] reserved for manual wood crafting (bob greenhouse)
-- TEMPERATE WOOD GENERATOR
-- TEMPERATE WOOD ARBORETUM
-- TEMPERATE WOOD PROCESSING -- 20 ethanol / 5 liquid resin -- average 25 liquid resin / 40 wood
...
-- DESERT WOOD PROCESSING
  ...
  icons = angelsmods.functions.create_viscous_liquid_recipe_icon(
    ...
    {
      mods["bobplates"] and {
        "__bobplates__/graphics/icons/resin.png",
        32
      } or "solid-resin"
    }
  ),
