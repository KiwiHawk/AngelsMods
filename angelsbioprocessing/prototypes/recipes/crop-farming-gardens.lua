...
--icon = "__angelsbioprocessing__/graphics/icons/swamp-garden.png",
--icon = "__angelsbioprocessing__/graphics/icons/swamp-garden.png",
--COMPOST -- order a[support]-cb reserved for bob fertilizer
--{
--  type = "recipe",
...
--shift = {0,-5}
  ...
  always_show_products = true,
  show_amount_in_title = false,
  icons = {{icon = "__angelsbioprocessing__/graphics/icons/swamp-garden.png"}, {
    icon = "__angelsbioprocessing__/graphics/icons/token-bio.png",
    scale = 0.35,
    shift = {-seed_icon_shift, seed_icon_shift}
  }},
  ...
  icons = angelsmods.functions.create_solid_recipe_icon(nil, "solid-soil", {
    "solid-mud"
  }),
  icon_size = 32,
  order = "a[support]-aa"
  ...
  icons = {{icon = "__angelsbioprocessing__/graphics/icons/token-bio.png"}, {
    icon = "__angelsbioprocessing__/graphics/icons/temperate-garden.png",
    scale = 0.35,
    shift = {-seed_icon_shift, seed_icon_shift}
  }, {
