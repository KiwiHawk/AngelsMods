...
--{type="item", name="solid-trinitrotoluene", amount=1},
  ...
  icons = AF.create_solid_recipe_icon({"liquid-naphtha"}, "solid-fuel"),
  crafting_machine_tint = AF.get_recipe_tints({{
    r = 105 / 255,
    g = 105 / 255,
    b = 105 / 255
  }, "liquid-naphtha", AF.fluid_color("Cb")}),
  ...
  icons = AF.create_solid_recipe_icon({"liquid-fuel-oil"}, "solid-fuel"),
  crafting_machine_tint = AF.get_recipe_tints({{
    r = 105 / 255,
    g = 105 / 255,
    b = 105 / 255
  }, "liquid-fuel-oil", AF.fluid_color("Cb")}),
  ...
  icons = AF.create_solid_recipe_icon({"gas-synthesis"}, "solid-fuel"),
  crafting_machine_tint = AF.get_recipe_tints({{
    r = 105 / 255,
    g = 105 / 255,
    b = 105 / 255
  }, "gas-synthesis", AF.fluid_color("Cb")}),
  ...
  crafting_machine_tint = AF.get_recipe_tints({{
    ...
    g = 0,
    b = 0
  }, "liquid-glycerol", "liquid-sulfuric-acid", "liquid-nitric-acid"}),
  ...
  crafting_machine_tint = AF.get_recipe_tints({{
    ...
    g = 0,
    b = 0
  }, "liquid-toluene", "liquid-sulfuric-acid", "liquid-nitric-acid"}),
