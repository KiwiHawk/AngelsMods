...
data:extend --[[coke]] --[[{089, 102, 157}]]({{
--CARBON
--GAS FEED
--{type = "item", name = "membrane", amount = 1}
--OIL FEED
--SYNTHESIS --Co --Fe --Zn and Al
--STEAM CRACKING --Ag --Fe
--CHEMISTRY --Ti OR Cr --Zinc, Copper, Aluminium --Aluminium --Aluminium --Ag, Or FeO & Mo and/or V --Fe --Fe
--ADVANCED CHEMISTRY
...
--{type = "item", name = "catalyst-metal-carrier", amount = 1, catalyst_amount = 1}
  ...
  always_show_products = true,
  icons = angelsmods.functions.create_liquid_recipe_icon(
    {"liquid-fuel-oil", "liquid-naphtha", "liquid-mineral-oil"},
    "OiOiOi"
  ),
  crafting_machine_tint = AF.get_recipe_tints({
    "liquid-naphtha",
  ...
  icons = angelsmods.functions.create_liquid_recipe_icon(
    {"liquid-mineral-oil"},
    {{192, 096, 096}, {243, 135, 000}, {036, 036, 036}}
  ),
  crafting_machine_tint = AF.get_recipe_tints({
    "liquid-mineral-oil",
    "liquid-naphtha",
  ...
  icons = angelsmods.functions.create_gas_recipe_icon(
    {
      {
        "__angelspetrochem__/graphics/icons/molecules/polyethylene.png",
        72,
        {11.5 * 32 / 10.24, 0},
        32 / 10.24
      }
  ...
  icons = angelsmods.functions.create_liquid_recipe_icon(
    {
      {
        "__angelspetrochem__/graphics/icons/molecules/ethylene-carbonate.png",
        72
      }
    },
    "COH"
