...
--BASIC CHEMISTRY
--COAL CRACKING --Gasification --COKE --Bergius-Process --Fe --COKE --Fischer-Tropsch Ammonia and Methanol feed
...
--ENRICHED WATER
  {{
    ...
    icons = AF.create_gas_recipe_icon({"steam"}, "WsWsWs", {"water"}),
    ...
    always_show_products = true,
    icons = AF.create_gas_recipe_icon({"steam"}, "WsWsWs", {"water-purified"}),
    ...
    always_show_products = true,
    icons = AF.create_liquid_recipe_icon({"water-purified"}, "WsWsWs"),
    ...
    crafting_machine_tint = AF.get_recipe_tints({"gas-carbon-dioxide", {
      r = 0,
      g = 0,
      b = 0,
      a = 1
    ...
    icons = AF.create_gas_recipe_icon(
      {
        ...
        {
          "__angelspetrochem__/graphics/icons/molecules/hydrogen-sulfide.png",
          72
        }
      },
      "OiOiOi"
    ...
    crafting_machine_tint = AF.get_recipe_tints({{
      ...
      g = 1,
      b = 1
    }, "gas-hydrogen-sulfide", "gas-methane", "gas-benzene"})
  }, {
    type = "recipe",
    ...
    always_show_products = true,
    icons = AF.create_gas_recipe_icon(
      {"liquid-mineral-oil", "liquid-ngl", "liquid-naphtha"},
      "OiOiOi"
    ),
    order = "g[coal-cracking-2]",
    crafting_machine_tint = AF.get_recipe_tints({"liquid-naphtha", {
      r = 1,
      g = 1,
      b = 1
    }, "liquid-ngl", "gas-hydrogen", "liquid-mineral-oil"})
  }, {
    type = "recipe",
    name = "coal-cracking-3",
    category = "advanced-chemistry",
    subgroup = "petrochem-coal",
    energy_required = 4,
    enabled = false,
    ...
    crafting_machine_tint = AF.get_recipe_tints({{
      ...
      g = 1,
      b = 1
    }, "gas-nitrogen", "water", AF.fluid_color("NaCO3")})
  }, {
    type = "recipe",
    name = "coal-crushed",
    ...
    crafting_machine_tint = AF.get_fluid_recipe_tint(
    ...
    localised_name = {
      "recipe-name.angels-water-enrichment",
      "2",
      "7.5",
      "12.5"
    },
