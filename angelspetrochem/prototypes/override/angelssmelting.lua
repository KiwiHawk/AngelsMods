...
if angelsmods.smelting then
  ...
  if angelsmods.trigger.smelting_products["silver"].ingot or angelsmods.trigger.smelting_products["silver"].wire or angelsmods.trigger.smelting_products["silver"].plate or angelsmods.trigger.smelting_products["silver"].powder or angelsmods.trigger.smelting_products["gold"].ingot or angelsmods.trigger.smelting_products["gold"].wire or angelsmods.trigger.smelting_products["gold"].plate or angelsmods.trigger.smelting_products["gold"].powder then
  else
    OV.disable_recipe({"solid-sodium-cyanide"})
