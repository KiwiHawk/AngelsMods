...
if mods["bobplates"] then
  angelsmods.functions.add_flag(
    {"void-pump", "air-pump", "air-pump-2", "air-pump-3", "air-pump-4"},
    "hidden"
  )
...
if mods["bobplates"] then
  ...
  OV.patch_recipes({{
    ...
    ingredients = {{
      ...
      type = "fluid",
      amount = "liquid-fuel-oil"
    }}
  }})
  --hide disabled
elseif mods["bobelectronics"] then
  OV.hide_recipe({"coal-cracking", "bob-resin-oil"})
end
