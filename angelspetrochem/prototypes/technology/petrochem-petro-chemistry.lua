...
--"basic-chemistry-3",
  ...
  icon_size = 128,
  prerequisites = {"basic-chemistry-3", "fluid-handling"},
  effects = {{
    type = "unlock-recipe",
    recipe = "pumpjack"
  }, {
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"oil-gas-extraction"},
  effects = {{
    type = "unlock-recipe",
    recipe = "oil-refinery"
  }, {
  ...
  icon_size = 256,
  icon_mipmaps = 2,
  prerequisites = {"gas-steam-cracking-2"},
  effects = {{
    type = "unlock-recipe",
    recipe = "gas-refinery"
  }, {
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"angels-fluid-control"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelspetrochem__/graphics/technology/advanced-chemical-plant-tech.png",
  icon_size = 128,
  prerequisites = {"angels-advanced-chemistry-4", "utility-science-pack"},
  effects = {{
    type = "unlock-recipe",
    recipe = "separator-4"
  }, {
  ...
  prerequisites = {"angels-advanced-chemistry-3"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelspetrochem__/graphics/technology/steam-cracker-tech.png",
  icon_size = 128,
  prerequisites = {"oil-processing", "angels-advanced-chemistry-1"},
  effects = {{
    type = "unlock-recipe",
    recipe = "steam-cracker"
  }, {
  ...
  icon_size = 128,
  prerequisites = {"oil-steam-cracking-1", "gas-steam-cracking-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelspetrochem__/graphics/technology/electric-boiler-tech.png",
  icon_size = 128,
  prerequisites = {"angels-electric-boiler-2", "angels-advanced-chemistry-5"},
  effects = {{
    type = "unlock-recipe",
