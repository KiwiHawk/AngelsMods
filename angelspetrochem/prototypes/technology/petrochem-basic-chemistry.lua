...
--{type = "item", name = "chemical-science-pack", amount = 1}
  ...
  prerequisites = {"basic-chemistry", "water-treatment"},
  effects = {{
    type = "unlock-recipe",
  ...
  prerequisites = {"angels-coal-processing", "water-treatment-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  prerequisites = {"angels-coal-processing-3", "angels-advanced-chemistry-3"},
  effects = {{
    type = "unlock-recipe",
    recipe = "pellet-coke"
  }, {
  ...
  prerequisites = {"water-treatment-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icons = angelsmods.functions.create_gas_tech_icon("SSS"),
  prerequisites = {"angels-sulfur-processing-3"},
  effects = {},
  unit = {
    count = 50,
    ingredients = {{
  ...
  prerequisites = {"ore-crushing", "gas-processing"},
  effects = {{
    type = "unlock-recipe",
  ...
  icons = angelsmods.functions.create_gas_tech_icon("ClClCl"),
  prerequisites = {"chlorine-processing-1", "gas-steam-cracking-1"},
  effects = {{
    type = "unlock-recipe",
