...
--WEAPONARY
  ...
  icon_size = 128,
  prerequisites = {"angels-nitrogen-processing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelspetrochem__/graphics/technology/booster-tech.png",
  icon_size = 128,
  prerequisites = {"rocket-booster-1", "chlorine-processing-4"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelspetrochem__/graphics/technology/tnt-tech.png",
  icon_size = 128,
  prerequisites = {"angels-explosives-1", "angels-advanced-chemistry-3"},
  effects = {{
    type = "unlock-recipe",
