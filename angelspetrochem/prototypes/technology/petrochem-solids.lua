...
-- Separate nuclear fuel since changed recipes
  ...
  icon_size = 128,
  prerequisites = {"gas-steam-cracking-1", "oil-steam-cracking-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"plastic-1", "angels-advanced-chemistry-3"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"plastic-2", "angels-advanced-chemistry-5"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelspetrochem__/graphics/technology/separator-tech.png",
  icon_size = 128,
  prerequisites = {"resin-1", "angels-nitrogen-processing-3"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelspetrochem__/graphics/technology/separator-tech.png",
  icon_size = 128,
  prerequisites = {"angels-advanced-chemistry-2"},
  effects = {{
    type = "unlock-recipe",
