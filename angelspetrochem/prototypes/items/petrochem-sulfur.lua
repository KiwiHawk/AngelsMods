...
data:extend({{
--SULFUR
--icon_size = 32, --{r = 1, g = 1, b = 0.3}, --{r = 1, g = 1, b = 0.3},
--icon_size = 32, --{r = 1, g = 1, b = 0.3}, --{r = 1, g = 1, b = 0.3},
--icon_size = 32, --{r = 0.9, g = 0.9, b = 0.2}, --{r = 0.9, g = 0.9, b = 0.2},
--icon_size = 32, --{r = 0.8, g = 0.8, b = 0.1}, --{r = 0.8, g = 0.8, b = 0.1},
  type = "fluid",
  name = "gas-hydrogen-sulfide",
  localised_description = show_formula and {
    "tooltip-description.chemical-formula",
    "H[font=default-tiny-bold]2[/font]S"
  } or nil,
  ...
  gas_temperature = 25,
  heat_capacity = "0.1KJ",
  base_color = angelsmods.functions.fluid_color("H2S"),
  flow_color = angelsmods.functions.flow_color("H2S"),
  max_temperature = 100
}, {
  type = "fluid",
  ...
  gas_temperature = 25,
  heat_capacity = "0.1KJ",
  base_color = angelsmods.functions.fluid_color("S2HWt"),
  flow_color = angelsmods.functions.flow_color("S2HWt"),
  max_temperature = 100,
  auto_barrel = false
}, {
  type = "fluid",
  ...
  localised_description = show_formula and {
    "tooltip-description.chemical-formula",
    "SO[font=default-tiny-bold]2[/font]"
  } or nil,
  icons = angelsmods.functions.create_gas_fluid_icon(
  ...
  gas_temperature = 25,
  heat_capacity = "0.1KJ",
  base_color = angelsmods.functions.fluid_color("SO2"),
  flow_color = angelsmods.functions.flow_color("SO2"),
  max_temperature = 100
}, {
  type = "fluid",
  ...
  default_temperature = 25,
  heat_capacity = "0.1KJ",
  base_color = angelsmods.functions.fluid_color("SH2O4Ws"),
  flow_color = angelsmods.functions.flow_color("SH2O4Ws"),
  max_temperature = 100
}, {
  type = "item",
