...
if angelsmods.addons.storage.silos then
  ...
  table.insert(
    available_storage,
    "[font=default-bold] NOTE[/font]: Includes logistics versions once unlocked"
  )
end
if angelsmods.addons.storage.oresilos then
  ...
  table.insert(
    available_storage,
    "[font=default-bold] NOTE[/font]: Colours and textures based on angels 6 base ores"
  )
end
...
table.insert(description, {
  "tips-and-tricks-description.angelsaddons-storage-notes"
})
return description