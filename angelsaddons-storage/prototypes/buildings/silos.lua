...
if angelsmods.addons.storage.oresilos then
  ...
  for order, name in pairs(ore_silo) do
    ...
    cont_add.icon =
      "__angelsaddons-storage__/graphics/icons/silo-" .. name .. ".png"
    cont_add.picture.filename =
      "__angelsaddons-storage__/graphics/entity/silo-" .. name .. ".png"
...
if angelsmods.addons.storage.silos then
  ...
  for name, stat in pairs(log_names) do
    ...
    cont_add.icon =
      "__angelsaddons-storage__/graphics/icons/silo-log-" .. name .. ".png"
    cont_add.picture.filename =
      "__angelsaddons-storage__/graphics/entity/silo-log-" .. name .. ".png"
