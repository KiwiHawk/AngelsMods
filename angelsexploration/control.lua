...
script.on_event(
  ...
  function(event)
    gathering_turret:on_damaged_entity(
      event.entity,
      event.cause,
...
script.on_event(defines.events.on_research_finished, function(event)
  gathering_turret:on_tech_research_finished(
    event.research.force.name,
    event.research.name
  )
  tips_and_tricks_triggers:on_tech_research_finished(
    event.research.force.name,
    event.research.name
  )
end)
script.on_event(defines.events.on_research_reversed, function(event)
  gathering_turret:on_tech_research_reversed(
    event.research.force.name,
    event.research.name
  )
end)
