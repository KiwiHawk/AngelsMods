...
local create_spider_vehicle_leg = function(
entity_name,
  entity_scale,
  entity_identifier
)
...
data:extend({{
  ...
  stack_size = 1
}, create_spider_vehicle_body(
  entity_name,
  entity_scale
), create_spider_vehicle_leg(entity_name, entity_scale, "1"), create_spider_vehicle_leg(entity_name, entity_scale, "2"), create_spider_vehicle_leg(entity_name, entity_scale, "3"), create_spider_vehicle_leg(entity_name, entity_scale, "4"), create_spider_vehicle_leg(entity_name, entity_scale, "5"), create_spider_vehicle_leg(entity_name, entity_scale, "6"), create_spider_vehicle_leg(entity_name, entity_scale, "7"), create_spider_vehicle_leg(entity_name, entity_scale, "8")})
--]]--