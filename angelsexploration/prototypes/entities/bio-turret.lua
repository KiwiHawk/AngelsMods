...
local bio_turret_gun_center_base =
  math3d.vector2.sub({0, -0.725}, bio_turret_gun_shift.south)
...
local bio_turret_extension_animation = function(shft, opts)
  ...
  return {layers = bio_turret_foreach(ret_layers, function(tab)
    if tab.shift then
...
local bio_turret_extension = function(opts)
  ...
  return {
    north = bio_turret_extension_animation(
      bio_turret_gun_shift.north,
      set_direction(opts, "north")
    ),
    east = bio_turret_extension_animation(
      bio_turret_gun_shift.east,
      set_direction(opts, "east")
    ),
    south = bio_turret_extension_animation(
      bio_turret_gun_shift.south,
      set_direction(opts, "south")
    ),
    west = bio_turret_extension_animation(
      bio_turret_gun_shift.west,
      set_direction(opts, "west")
    )
  }
end
...
local bio_turret_preparing_muzzle_animation = function(opts)
  ...
  local angle_raised =
    -math3d.vector3.angle(
      {1, 0, 0},
      math3d.vector3.sub(model.gun_tip_raised, model.tilt_pivot)
    )
  local angle_lowered =
    -math3d.vector3.angle(
      {1, 0, 0},
      math3d.vector3.sub(model.gun_tip_lowered, model.tilt_pivot)
    )
...
data:extend({{ -- 15 minutes
--tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 },
--tint = { r = 0.869, g = 0.5  , b = 0.130, a = 0.5 }, -- 0.015 -- 1 -- 5s to fill the buffer
-- diffuse
-- mask
-- shadow
-- diffuse
...
--{type = "light-oil", damage_modifier = 1.1} -- 0.2 = 3/s
  type = "item",
  ...
  folded_animation = bio_turret_extension({
    frame_count = 1,
    line_length = 1
  }),
  ...
  enough_fuel_indicator_picture = bio_turret_foreach(
  ...
  attack_parameters = {
    ...
    turn_range = 1.0 / 3.0,
    fire_penalty = 15,
    fluids = {{type = "crude-oil"}, {
      type = "lubricant",
      damage_modifier = 1.05
    }},
    fluid_consumption = 0.2,
    gun_center_shift = {
      north = math3d.vector2.add(
        bio_turret_gun_center_base,
        bio_turret_gun_shift.north
      ),
      east = math3d.vector2.add(
        bio_turret_gun_center_base,
        bio_turret_gun_shift.east
      ),
      south = math3d.vector2.add(
        bio_turret_gun_center_base,
        bio_turret_gun_shift.south
      ),
      west = math3d.vector2.add(
        bio_turret_gun_center_base,
        bio_turret_gun_shift.west
      )
    },
