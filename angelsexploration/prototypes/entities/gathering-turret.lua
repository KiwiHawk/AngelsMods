...
-- GATHERING TURRET
data:extend({{ -- select the gatering turret rather than the base
...
-- attack state
--attacking_speed = 0.1, -- defaults to 0

-- folding state
--turret_base_has_direction = true, -- in ticks
--turn_range = 0.5, -- 180°
  type = "item",
  ...
  minable = {
    mining_time = 0.1,
    result = "angels-gathering-turret"
  },
  max_health = 1000,
  ...
  attack_target_mask = {"angels_gathering_turret_start_collecting_trigger"},
  ...
  rotation_speed = 0.01,
  prepared_animation = angelsmods.functions.create_gathering_turret_shootings{
    shift = {0, -0.46},
    scale = 0.78
  },
