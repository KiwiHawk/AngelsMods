local create_description =
  require"prototypes.tips-and-tricks.1-2-x-native-houses.1-2-x-native-houses-description"
...
for spawner_idx, spawner_data in pairs(navive_data) do
  ...
  --simulation = require "prototypes.tips-and-tricks.1-ore-refining.1-ore-refining-simulation",
    ...
    localised_name = data.raw["unit-spawner"][spawner_name].localised_name or {
      "tips-and-tricks-name.angels-native-inhabitants-spawner",
      "__ENTITY__" .. spawner_name .. "__"
    },
