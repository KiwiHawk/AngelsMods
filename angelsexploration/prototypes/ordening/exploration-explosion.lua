...
reorder(
  ...
  "cannon-shell",
  "angels-exploration-tank-a",
  "c[ammo]-a[basic-shell]"
)
reorder(
  "ammo",
  "explosive-cannon-shell",
  "angels-exploration-tank-a",
  "c[ammo]-b[explosive-shell]"
)
reorder(
  "ammo",
  "uranium-cannon-shell",
  "angels-exploration-tank-a",
  "c[ammo]-c[uranium-shell]"
)
reorder(
  "ammo",
  "explosive-uranium-cannon-shell",
  "angels-exploration-tank-a",
  "c[ammo]-d[explosive-uranium-shell]"
)
if mods["bobwarfare"] then
  reorder(
    "ammo",
