...
if mods["bobwarfare"] then
  reorder(
    ...
    "angels-artillery-a",
    "b[turret]-b[artillery]"
  )
  reorder(
    "item",
    "bob-artillery-turret-3",
    "angels-artillery-a",
    "b[turret]-c[artillery]"
  )
end
...
if mods["bobwarfare"] then
  ...
  reorder(
    ...
    "angels-artillery-b",
    "c[ammo]-b[distractor-shell]"
  )
  reorder(
    "ammo",
    "poison-artillery-shell",
    "angels-artillery-b",
    "c[ammo]-c[poison-shell]"
  )
  reorder(
    "ammo",
  ...
  reorder(
    ...
    "angels-artillery-b",
    "c[ammo]-e[explosive-shell]"
  )
  reorder(
    "ammo",
    "atomic-artillery-shell",
    "angels-artillery-b",
    "c[ammo]-f[distractor-shell]"
  )
end
