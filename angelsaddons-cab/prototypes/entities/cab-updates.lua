if not mods["angelsindustries"] then
  ...
  for _, equipmentType in pairs{--"night-vision-equipment",
    --"energy-shield-equipment",
    "battery-equipment", "solar-panel-equipment", "generator-equipment", --"movement-bonus-equipment", --"active-defense-equipment", --"active-defense-equipment",
    "roboport-equipment"} do
