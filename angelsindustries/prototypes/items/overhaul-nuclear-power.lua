...
-------------------------------------------------------------------------------
data:extend({{
--U-234 -- green (the rarest of the shiny rocks)
...
--Np-240 -- cyan/blue
--Pu-240 -- orange
--Am-241 -- translucent white (bleeched color)
--Cm-245 -- yellowed silver
--Th-232 -- red (almost maroon)
  type = "item",
  name = "uranium-234",
...
-- NUCLEAR TRAIN FUEL --1.21*1.21 --1.21*(1.21*1.5)
  type = "item",
...
data:extend({{
--uranium-cell -- Green with hint of yellow
--order "a[uranium]-b" reserved for uranium-fuel-cell
--order "a[uranium]-c" reserved for used-up-uranium-fuel-cell
--AMOX-cell -- Orange, slightly yellow
--thorium-cell --down from 50 -- Red, slightly towards orange
--deuterium-cell -- cyan per Lovely_Santa
  type = "item",
  ...
  fuel_value = "1.5GJ",
  fuel_glow_color = util.color("6aff00"),
  stack_size = 50
}, {
  type = "item",
  name = "AMOX-cell",
  ...
  fuel_value = "8GJ",
  fuel_glow_color = util.color("ff9500"),
  stack_size = 50
}, {
  type = "item",
  ...
  fuel_value = "15GJ",
  fuel_glow_color = util.color("ff190d"),
  stack_size = 50
}, {
  type = "item",
  ...
  fuel_value = "80GJ",
  fuel_glow_color = util.color("00d5ff"),
  stack_size = 50
}, {
  type = "item",
