...
--energy_usage = "100kW",
-- stationing_offset = {0, 0},
-- charging_offsets = {{0, 0}}, -- 200kW drain + 1 * 200kW recharging bots + 200kW buffer filling
--drain = "100kW"
--energy_usage = "100kW",
  type = "item",
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-construction-zone-expander"
  },
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-construction-zone-expander-2"
  },
  fast_replaceable_group = "roboport",
  max_health = 500,
  corpse = "small-remnants",
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-construction-zone-expander-3"
  },
  fast_replaceable_group = "roboport",
  max_health = 500,
  corpse = "small-remnants",
