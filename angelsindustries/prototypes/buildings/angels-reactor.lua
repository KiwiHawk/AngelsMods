...
if angelsmods.industries.overhaul then
  ...
  -- light = {intensity = 0.6, size = 9.9, shift = {0.0, 0.0}, color = {r = 0.0, g = 1.0, b = 0.0}}, -- should use glow color from fuel item prototype as light color and tint for working_light_picture
  ...
  -- idle_sound = { filename = "__base__/sound/idle1.ogg", volume = 0.3 },
    ...
    heat_connection_patches_connected = {sheet = apply_heat_pipe_glow{
    ...
    heat_connection_patches_disconnected = {sheet = apply_heat_pipe_glow{
      filename = "__angelsindustries__/graphics/entity/fast-reactor/fast-reactor-connect-patches-heated.png",
      width = 32,
      height = 32,
      variation_count = 16,
