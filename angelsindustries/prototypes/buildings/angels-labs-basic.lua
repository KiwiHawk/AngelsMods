  ...
  --BASIC LABs
    ...
    localised_description = {
      ...
      "\n",
      {
        ...
        create_rich_text_icons{"angels-science-pack-grey", "datacore-basic"}
      }
    },
    icons = angelsmods.functions.add_number_icon_layer(
      {{
    ...
    inputs = {"angels-science-pack-grey", "datacore-basic"},
    ...
    localised_description = {
      ...
      {
        "entity-description.angels-lab-inputs",
        create_rich_text_icons{"angels-science-pack-white", "datacore-basic"}
      }
    },
    icons = angelsmods.functions.add_number_icon_layer(
      {{
    ...
    inputs = {"angels-science-pack-white", "datacore-basic"},
    module_specification = {
      module_slots = 3,
      module_info_max_icons_per_row = 3,
      module_info_max_icon_rows = 1,
