circuit_connector_definitions["cargo-hub"]
= circuit_connector_definitions.create(universal_connector_template, {{
  variation = 26,
  main_offset = util.by_pixel(0, 64),
  shadow_offset = util.by_pixel(2, 78),
  show_shadow = false
}})

data:extend({{
-- per one charge slot -- average pause between the sound is 5 seconds
-- per one charge slot -- average pause between the sound is 5 seconds
-- per one charge slot -- average pause between the sound is 5 seconds
  type = "item",
  name = "cargo-roboport",
  ...
  charging_offsets = {{-1, -1}, {-1, -3}, {1.5, -4}},
  base = {
