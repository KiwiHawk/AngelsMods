...
if angelsmods.industries.tech then
  data:extend({{
    ...
    minable = {
      mining_time = 0.5,
      result = "angels-accelerator-cyclotron"
    },
    max_health = 300,
    corpse = "big-remnants",
    ...
    minable = {
      mining_time = 0.5,
      result = "angels-accelerator-oneway"
    },
    max_health = 300,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    ...
    minable = {
      mining_time = 0.5,
      result = "angels-accelerator-oneway-curvea"
    },
    max_health = 300,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    ...
    minable = {
      mining_time = 0.5,
      result = "angels-accelerator-oneway-curveb"
    },
    max_health = 300,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    ...
    minable = {
      mining_time = 0.5,
      result = "angels-accelerator-oneway-splice"
    },
    max_health = 300,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    ...
    minable = {
      mining_time = 0.5,
      result = "angels-accelerator-oneway-target"
    },
    max_health = 300,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
    ...
    minable = {
      mining_time = 0.5,
      result = "angels-accelerator-collider"
    },
    max_health = 300,
    corpse = "big-remnants",
    dying_explosion = "medium-explosion",
