circuit_connector_definitions["angels-big-chest"]
= circuit_connector_definitions.create(universal_connector_template, {{
  variation = 26,
  main_offset = util.by_pixel(16, 16),
  shadow_offset = util.by_pixel(18, 28),
  show_shadow = false
}})
...
data:extend({{
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-logistic-chest-requester"
  },
  max_health = 350,
  corpse = "small-remnants",
  collision_box = {{-0.75, -0.75}, {0.75, 0.75}},
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-logistic-chest-passive-provider"
  },
  max_health = 350,
  corpse = "small-remnants",
  collision_box = {{-0.75, -0.75}, {0.75, 0.75}},
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-logistic-chest-active-provider"
  },
  max_health = 350,
  corpse = "small-remnants",
  collision_box = {{-0.75, -0.75}, {0.75, 0.75}},
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-logistic-chest-storage"
  },
  max_health = 350,
  corpse = "small-remnants",
  collision_box = {{-0.75, -0.75}, {0.75, 0.75}},
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-logistic-chest-buffer"
  },
  max_health = 350,
  corpse = "small-remnants",
  collision_box = {{-0.75, -0.75}, {0.75, 0.75}},
