...
= circuit_connector_definitions.create(universal_connector_template, {{
  variation = 26,
  main_offset = util.by_pixel(28, 36),
  shadow_offset = util.by_pixel(30, 48),
  show_shadow = false
}})

data:extend({{ -- 250kW drain + 4 * 500kW recharging bots + 750kW buffer filling
--drain = "200kW"
--[[door_animation =
      {
  ...
  minable = {
    mining_time = 0.5,
    result = "angels-charging-station"
  },
