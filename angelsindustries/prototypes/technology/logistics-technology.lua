...
-- },
  ...
  icon_size = 128,
  prerequisites = {"angels-construction-robots"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelsindustries__/graphics/technology/construction-robot-tech.png",
  icon_size = 128,
  prerequisites = {"angels-construction-robots", "cargo-robots"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelsindustries__/graphics/technology/cargo-robot-tech.png",
  icon_size = 128,
  prerequisites = {"cargo-robots", "advanced-electronics"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"angels-vequipment-1"},
  effects = {{
    type = "unlock-recipe",
