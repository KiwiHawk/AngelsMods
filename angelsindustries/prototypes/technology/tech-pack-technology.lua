...
if angelsmods.industries.tech then
  ...
  --TIER 4
    ...
    icon_size = 128,
    prerequisites = {"tech-red-circuit"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon_size = 128,
    prerequisites = {"tech-red-packs", "tech-green-circuit"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon_size = 128,
    prerequisites = {"tech-green-packs", "tech-orange-circuit"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon_size = 128,
    prerequisites = {"tech-orange-packs", "tech-blue-circuit"},
    effects = {{
      type = "unlock-recipe",
    ...
    icon_size = 128,
    prerequisites = {"tech-blue-packs", "tech-yellow-circuit"},
    effects = {{
      type = "unlock-recipe",
