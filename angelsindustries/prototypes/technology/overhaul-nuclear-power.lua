data:extend({{ -- bottom placeholder layer -- bottom placeholder layer
  type = "technology",
  ...
  icon_size = 128,
  prerequisites = {"angels-thorium-power", "water-chemistry-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"angels-fusion-power-1", "space-science-pack"},
  effects = {{
    type = "unlock-recipe",
