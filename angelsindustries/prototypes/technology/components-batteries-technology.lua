...
if angelsmods.industries.components then
  ...
  --"ore-floatation" --unlocks for basic blocks 3 which is a military tier (but does not have the packs)
  --"plastic-1",
    type = "technology",
    ...
    icon_size = 256,
    icon_mipmaps = 4,
    prerequisites = {"angels-sulfur-processing-1", "bio-paper-1"},
    effects = {{
      type = "unlock-recipe",
      recipe = "battery-1"
    }, {
    ...
    type = "technology",
    name = "angels-components-batteries-3",
    icon = "__base__/graphics/technology/battery.png",
    icon_size = 256,
    icon_mipmaps = 4,
    prerequisites = {
