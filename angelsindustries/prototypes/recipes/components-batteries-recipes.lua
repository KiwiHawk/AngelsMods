if angelsmods.industries.components then
  ...
  --[[contents:
    ...
    (CASE) "paper"]]
  ----------------------------------------------------------------------------- --could be lead-anode as an alternate recipe
  -----------------------------------------------------------------------------
  ...
  --[[contents:
    ...
    (C) nickel
    (CASE) glass casing]]
  ----------------------------------------------------------------------------- --move some of the zinc options down to equivalent tier, at least make a zinc-oxide from ore recipe --nickel-cathode as alternative --need to enable nickel plate
  -----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------- --want carbon sheet or carbon electrode --would prefer lithium-cobalt-oxide over these 2, if bobs is active i guess --lithia-water/ethylene carbonate --prefer lithia water if active --need to change this to Ethylene carbonate(aka ethylene glycol carbonate) [https://en.wikipedia.org/wiki/Ethylene_carbonate]
  -----------------------------------------------------------------------------
  ...
  --tint = {r=1,g=1,b=1}, --realistically, should be PEO, PAN, PMMA or PVdF
  -----------------------------------------------------------------------------
  ...
  ----------------------------------------------------------------------------- --substitute for sodium-carbon mixture --should be dioxide, not oxide --should be dioxide, not oxide --liquid-molten-glass/lithium-chloride --prefer lithium chloride or perchlorate
  -----------------------------------------------------------------------------
  -- BATTERY 6 PARTS ----------------------------------------------------------
  --[[contents:
    (A) zinc-plate
