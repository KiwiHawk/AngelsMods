if angelsmods.industries.components then
  ...
  for _, metal in
    pairs({"iron", "steel", "aluminium", "titanium" --[[,"tungsten"]]}) --all of the metals in one go
  do
    local num
    local molten1
    local molten2
  ...
  -----------------------------------------------------------------------------
  -- MOTOR BLOCKS -------------------------------------------------------------
  ----------------------------------------------------------------------------- -- 1:2 ratio with motor -- 2:3 ratio with motor -- 3:4 ratio with motor
  --{type = "fluid", name = "lubricant", amount = 10} -- 4:7 ratio with motor -- 3:5 ratio with motor
  -----------------------------------------------------------------------------
  -- MOTORS -------------------------------------------------------------------
  -----------------------------------------------------------------------------
  -----------------------------------------------------------------------------
