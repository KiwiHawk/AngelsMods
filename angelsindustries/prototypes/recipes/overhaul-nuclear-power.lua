...
--order a[uranium]-b[enrichment] reserved for kovarkex enrichment process --180 -- need to have something as bottom layer --540
--{type = "item", name = "uranium-235", amount = 1,probability=0.3}, -- equals 5 lead plates -- need to have something as bottom layer --must be low enough to not be self-sustainable (<=0.15) -- need to have something as bottom layer --unsure
  type = "recipe",
...
data:extend({{
--URANIUM FUEL
--advanced fuel cell --7000
--advanced reprocessing --120 -- need to have something as bottom layer
--icon_size = 32, -- "a[uranium]-c" reserved for vanilla reprocessing
--AMOX FUEL
--fuel cell --1200
--basic reprocessing --330 -- need to have something as bottom layer
--icon_size = 32,
--advanced reprocessing -- need to have something as bottom layer
--icon_size = 32,
--THORIUM FUEL
--basic fuel cell --1000
--advanced fuel cell
--[[{
    type = "recipe",
...
--basic reprocessing --450 --p=0.1 (0.5 is self sustaining) -- need to have something as bottom layer
--icon_size = 32,
-- advanced reprocessing -- 1000 -- need to have something as bottom layer
--icon_size = 32,
--DEUTERIUM FUEL
-- fuel cell --1500
--crafting_machine_tint = angelsmods.functions.get_fluid_recipe_tint("gas-deuterium"),
-- reprocessing --6000 -- make it lose 1%; 99% of 5 = 4.95 return -- need to have something as bottom layer
--icon_size = 32,
-- advanced reprocessing --6000 -- need to have something as bottom layer
--icon_size = 32,
  type = "recipe",
  ...
  order = "a[uranium]-d",
  crafting_machine_tint = {primary = tint_colors.green}
}, {
  type = "recipe",
  ...
  order = "b[AMOX]-c",
  crafting_machine_tint = {primary = tint_colors.orange}
}, {
  type = "recipe",
  ...
  order = "c[thorium]-d",
  crafting_machine_tint = {primary = tint_colors.red}
}, {
  type = "recipe",
  ...
  icon_size = 32,
  order = "d[deuterium]-a",
  crafting_machine_tint = {primary = tint_colors.blue}
}, {
  type = "recipe",
...
--icon_size = 64, icon_mipmaps = 4, --do i want this?
--icon = "__base__/graphics/icons/nuclear-fuel.png",
