...
if angelsmods.industries.overhaul then
  ...
  move_item(
    ...
    "a[radioactive-element]-b[uranium-235]"
  )
  move_item(
    "uranium-238",
    "angels-power-nuclear-processing",
    "a[radioactive-element]-c[uranium-238]"
  )
  move_item(
    "uranium-processing",
    "angels-power-nuclear-processing",
    "a[uranium]-a[processing]",
    "recipe"
  )
  move_item(
    "kovarex-enrichment-process",
    "angels-power-nuclear-processing",
    "a[uranium]-b[enrichment]",
    "recipe"
  )
...
if mods["bobpower"] then
  ...
  if settings.startup["bobmods-power-solar"].value then
    ...
    move_item(
      ...
      "a[solar-panel]-a[small]-a"
    )
    move_item(
      "solar-panel-small-2",
      "angels-power-solar-panel",
      "a[solar-panel]-a[small]-b"
    )
    move_item(
      "solar-panel-small-3",
      "angels-power-solar-panel",
      "a[solar-panel]-a[small]-c"
    )

    move_item(
      "solar-panel",
      "angels-power-solar-panel",
      "a[solar-panel]-b[medium]-a"
    )
    move_item(
      "solar-panel-2",
      "angels-power-solar-panel",
      "a[solar-panel]-b[medium]-b"
    )
    move_item(
      "solar-panel-3",
      "angels-power-solar-panel",
      "a[solar-panel]-b[medium]-c"
    )

    move_item(
      "solar-panel-large",
      "angels-power-solar-panel",
      "a[solar-panel]-c[large]-a"
    )
    move_item(
      "solar-panel-large-2",
      "angels-power-solar-panel",
      "a[solar-panel]-c[large]-b"
    )
    move_item(
      "solar-panel-large-3",
      "angels-power-solar-panel",
      "a[solar-panel]-c[large]-c"
    )
  end
  ...
  -- heat pipes
  if settings.startup["bobmods-power-steam"].value or settings.startup["bobmods-power-nuclear"].value or settings.startup["bobmods-power-heatsources"].value then
    data:extend({{
      type = "item-subgroup",
