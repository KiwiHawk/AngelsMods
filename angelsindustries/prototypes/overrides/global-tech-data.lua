if angelsmods.industries.tech then
  ...
  angelsmods.functions.add_exception(
  ...
  angelsmods.functions.add_exception(
    "tech-specialised-labs-advanced-exploration-2"
  )
  ...
  angelsmods.functions.add_exception(
    "tech-specialised-labs-advanced-logistic-2"
  )
  ...
  angelsmods.functions.add_exception(
    "tech-specialised-labs-advanced-processing-2"
  )
  ...
  if mods["bobtech"] then
    for _, ignore in
      pairs({--blue artifact tech
      "alien-blue-research", "bob-ap-bullets", "bob-shotgun-ap-shells", "bob-piercing-rocket", "alien-orange-research", "bob-electric-bullets", "bob-shotgun-electric-shells", "bob-electric-rocket", "alien-purple-research", "bob-acid-bullets", "bob-shotgun-acid-shells", "bob-acid-rocket", "alien-yellow-research", "bob-he-bullets", "bob-shotgun-explosive-shells", "bob-explosive-rocket", "alien-green-research", "bob-poison-bullets", "bob-shotgun-poison-shells", "bob-poison-rocket", "alien-red-research", "bob-flame-bullets", "bob-shotgun-flame-shells", "bob-flame-rocket", "bob-plasma-bullets", "bob-shotgun-plasma-shells", "bob-plasma-rocket"}) --orange artifact tech --purple artifact tech --yellow artifact tech --green artifact tech --red artifact tech --Plasma Updates
    do
