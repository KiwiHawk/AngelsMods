...
if angelsmods.industries.components then
  ...
  if mods["bobassembly"] and settings.startup["bobmods-assembly-electronicmachines"].value == true then
    ...
    for _, elec in
      pairs({-- todo: move cables and coils to smelting!
      "copper-cable", "angels-wire-coil-copper-converting", "angels-wire-gold", "angels-wire-coil-gold-converting", "basic-platinated-copper-wire", "angels-wire-coil-platinum-converting", "basic-silvered-copper-wire", "angels-wire-coil-silver-converting", "basic-tinned-copper-wire", "angels-wire-coil-tin-converting", "angels-roll-solder-converting", "circuit-red-board", "circuit-green-board", "circuit-orange-board", "circuit-blue-board", "circuit-grey-board", "circuit-grey-board-alternative", "circuit-red", "circuit-green", "circuit-orange", "circuit-blue", "circuit-yellow", "circuit-grey", "circuit-red-loaded", "circuit-green-loaded", "circuit-orange-loaded", "circuit-blue-loaded", "circuit-yellow-loaded", "circuit-resistor", "circuit-transistor", "circuit-microchip", "circuit-transformer", "circuit-cpu"}) --"circuit-yellow-board" --crafted with 2 fluids
    do
  ...
  if angelsmods.industries.tech then
    ...
    data:extend({{
      ...
      icon_size = 64,
      prerequisites = {"tech-red-circuit", "angels-components-mechanical-1"},
      effects = {{
        type = "unlock-recipe",
    ...
    if (angelsmods.industries.blocks.enhancement5 == false) and (angelsmods.industries.blocks.exploration == false) and (angelsmods.industries.blocks.logistic == false) then
