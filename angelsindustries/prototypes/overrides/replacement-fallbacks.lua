...
angelsmods.industries.block_replace = {
  ...
  concrete = {
    new = "block-construction-4",
    amt_multi = 1
  },
  --metals
  ["iron-plate"] = {
    new = "construction-frame-1",
    amt_multi = 1
  },
  ["steel-plate"] = {
    new = "construction-frame-2",
    amt_multi = 1
  },
  ["aluminium-plate"] = {
    new = "construction-frame-3",
    amt_multi = 1
  },
  ["titanium-plate"] = {
    new = "construction-frame-4",
    amt_multi = 1
  },
  ["tungsten-plate"] = {
    new = "construction-frame-5",
    amt_multi = 1
  },
  --electronics
  ["electronic-circuit"] = {
    new = "block-electronics-1",
    amt_multi = 1
  },
  ["advanced-circuit"] = {
    new = "block-electronics-2",
    amt_multi = 1
  },
  ["processing-unit"] = {
    new = "block-electronics-4",
    amt_multi = 1
  }, --always 4 with bobs or vanilla
  ["basic-circuit-board"] = {
    new = "block-electronics-0",
    amt_multi = 1
  },
  ...
  ["advanced-processing-unit"] = {
    new = "block-electronics-5",
    amt_multi = 1
  },
  --pipes (fluid box replacements)
  ["copper-pipe"] = {
    new = "block-fluidbox-1",
    amt_multi = 0.5
  },
  pipe = {
    new = "block-fluidbox-1",
...
angelsmods.industries.general_replace = {
  ...
  ["basic-electronic-board"] = {
    new = "circuit-red-loaded",
    amt_multi = 1,
    unlock_by = "electronics"
  },
  ["electronic-circuit"] = {
    new = "circuit-red-loaded",
    amt_multi = 1
  ...
  ["advanced-circuit"] = {
    new = "circuit-green-loaded",
    amt_multi = 1,
    unlock_by = "advanced-electronics"
  },
  ["processing-unit"] = {
    new = "circuit-blue-loaded",
    amt_multi = 1,
    unlock_by = "advanced-electronics-2"
  },
  ["advanced-processing-unit"] = {
    new = "circuit-yellow-loaded",
    amt_multi = 1,
    unlock_by = "advanced-electronics-3"
  },
  --electronic components/boards
  ["wooden-board"] = {
    new = "circuit-grey-board",
    amt_multi = 1,
    alt_rec = "bio-paper-1"
  },
  ["phenolic-board"] = {
    new = "circuit-orange-board",
    amt_multi = 1,
    unlock_by = "advanced-electronics"
  },
  ["fibreglass-board"] = {
  ...
  ["basic-electronic-components"] = {
    new = "circuit-resistor",
    amt_multi = 1,
    unlock_by = "electronics"
  },
  ["electronic-components"] = {
    new = "circuit-transistor",
    amt_multi = 1,
    unlock_by = "advanced-electronics"
  },
  ["intergrated-electronics"] = {
    new = "circuit-microchip",
    amt_multi = 1,
    unlock_by = "advanced-electronics-2"
  },
  ...
  ["steel-gear-wheel"] = {
    new = "angels-gear",
    amt_multi = 1,
    unlock_by = "steel-processing"
  },
  ["brass-gear-wheel"] = {
    new = "angels-axle",
    amt_multi = 1,
    unlocked_by = "zinc-processing"
  },
  ["cobalt-steel-gear-wheel"] = {
    new = "angels-roller-chain",
    amt_multi = 1,
    unlocked_by = "cobalt-processing"
  },
  ["titanium-gear-wheel"] = {
    new = "angels-spring",
    amt_multi = 1,
    unlocked_by = "titanium-processing"
  },
  ["tungsten-gear-wheel"] = {
    new = "angels-bearing",
    amt_multi = 1,
    unlocked_by = "tungsten-processing"
  },
  --intermediates (vanilla)
  ["engine-unit"] = {
    new = "motor-2",
...
if mods["aai-industry"] then
  angelsmods.industries.block_replace["stone-brick"] = {
    new = "block-construction-1",
    amt_multi = 2
  }
end
if mods["bobelectronics"] then
  angelsmods.industries.block_replace["advanced-circuit"] = {
    new = "block-electronics-2",
    amt_multi = 1
  }
  ...
  angelsmods.industries.general_replace["advanced-circuit"] = {
    new = "circuit-orange-loaded",
    amt_multi = 1,
    unlock_by = "advanced-electronics"
  }
end
if mods["bobplates"] then
  angelsmods.industries.general_replace["lithium-ion-battery"] = {
    new = "battery-3",
    amt_multi = 1
  }
  angelsmods.industries.general_replace["silver-zinc-battery"] = {
    new = "battery-6",
    amt_multi = 1
  }
end