...
angelsmods.addons.mobility.number_tint = {
  r = 0.95,
  g = 0.65,
  b = 0.25,
  a = 1
...
angelsmods.addons.mobility.crawlertrain =
  angelsmods.addons.mobility.crawlertrain or {}
angelsmods.addons.mobility.crawlertrain.enabled =
  settings.startup["angels-crawlertrain-tier-amount"].value >= 1 and true or false
angelsmods.addons.mobility.crawlertrain.tier_amount =
  settings.startup["angels-crawlertrain-tier-amount"].value
angelsmods.addons.mobility.crawlertrain.number_tint = {
  r = 0.95,
  g = 0.65,
  b = 0.25,
  a = 1
...
angelsmods.addons.mobility.petrotrain =
  angelsmods.addons.mobility.petrotrain or {}
angelsmods.addons.mobility.petrotrain.enabled =
  settings.startup["angels-petrotrain-tier-amount"].value >= 1 and true or false
angelsmods.addons.mobility.petrotrain.tier_amount =
  settings.startup["angels-petrotrain-tier-amount"].value
angelsmods.addons.mobility.petrotrain.number_tint = {
  r = 0.92,
  g = 0.07,
  b = 0,
  a = 0.5
...
angelsmods.addons.mobility.smeltingtrain =
  angelsmods.addons.mobility.smeltingtrain or {}
angelsmods.addons.mobility.smeltingtrain.enabled =
  settings.startup["angels-smeltingtrain-tier-amount"].value >= 1 and true or false
angelsmods.addons.mobility.smeltingtrain.tier_amount =
  settings.startup["angels-smeltingtrain-tier-amount"].value
angelsmods.addons.mobility.smeltingtrain.number_tint = {
  r = 1,
  g = 0.38,
  b = 0,
  a = 1
