...
-- Train categories ------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------
for _, equipment_category in pairs{--"angels-void", --covered above
  "angels-basegame-attack", "angels-basegame-defense", "angels-basegame-movement", "angels-basegame-energy", "angels-basegame-construction"} do
