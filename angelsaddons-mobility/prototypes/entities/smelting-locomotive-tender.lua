local minimap_representation =
  data.raw["locomotive"]["locomotive"].minimap_representation
local selected_minimap_representation =
  data.raw["locomotive"]["locomotive"].selected_minimap_representation
...
data:extend({{ --"angels-energy", "angels-heavy-defense", "angels-movement"
  type = "equipment-grid",
...
funcs.generate_train_entities({ -- this is a percentage of current speed that will be subtracted
-- front left side --125
-- smoke goes to the left
-- front right side --125
