local fluid_minimap_representation =
  data.raw["fluid-wagon"]["fluid-wagon"].minimap_representation
local fluid_selected_minimap_representation =
  data.raw["fluid-wagon"]["fluid-wagon"].selected_minimap_representation
...
local tintable_tint = {
  ...
  b = 000 / 255,
  a = 0.5
} -- alpha must be 0.5 due to base game...
data:extend({{ --"angels-energy", "angels-repair", "angels-heavy-defense", "angels-construction", "angels-movement"
  type = "equipment-grid",
