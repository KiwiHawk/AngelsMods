data:extend --[[,"stone-crushed"]]({{ --get_fluid_recipe_tint("water-mineralized"),
--WASTE WATER TREATMENT
--{type="item", name="fluorite-ore", amount=1},
--SALINATION
--WASHING
--WASHING FILTERING --may need a better custom tint for "rainbow"
  type = "recipe",
  ...
  icons = angelsmods.functions.create_liquid_recipe_icon(
    {
      ...
      "water-purified",
      mods["angelspetrochem"] and {
        "__angelspetrochem__/graphics/icons/solid-sodium-nitrate.png",
        32
      } or nil
    },
    "WsOO"
  ...
  icons = angelsmods.functions.create_liquid_recipe_icon(
    {
      ...
      "water-purified",
      mods["angelspetrochem"] and {
        "__angelspetrochem__/graphics/icons/ore-fluorite.png",
        32
      } or nil
    },
    "WsFF"
  ...
  icons = angelsmods.functions.create_solid_recipe_icon(nil, "solid-salt", {
    "water-saline"
  }),
