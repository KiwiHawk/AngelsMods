...
if mods["bobplates"] then
  ...
  if
    (angelsmods.smelting and angelsmods.trigger.smelting_products["lithium"].plate or mods["bobplates"])
    or (angelsmods.industries and angelsmods.industries.overhaul)
  then
  else
