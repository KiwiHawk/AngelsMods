data:extend({{
--RESOURCE CATEGORIES
--RECIPE CATEGORIES -- used for machines that don't have a purpose }, -- used for manual crafting in character only }, -- crusher -- powderizer -- flotation -- leaching -- electrowinning -- refinery
-- water treatment
--SUBGROUPS
--WATER TREATMENT
--BARRELS
...
--VOID
  ...
  name = "angels-unused-machine"
}, {
  type = "recipe-category",
  name = "angels-manual-crafting"
}, {
  type = "recipe-category",
  name = "ore-refining-t1"
}, {
  type = "recipe-category",
  name = "ore-refining-t1-5"
}, {
  type = "recipe-category",
  name = "ore-refining-t2"
}, {
  type = "recipe-category",
  name = "ore-refining-t3"
}, {
  type = "recipe-category",
  name = "ore-refining-t3-5"
}, {
  type = "recipe-category",
  name = "ore-refining-t4"
}, {
  type = "recipe-category",
  name = "ore-sorting"
}, {
  ...
  type = "recipe-category",
  name = "crystallizing-2"
}, {
  type = "recipe-category",
  name = "crystallizing-3"
}, {
  type = "recipe-category",
  name = "liquifying"
}, {
