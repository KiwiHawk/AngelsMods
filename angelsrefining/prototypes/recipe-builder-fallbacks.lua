...
angelsmods.functions.RB.set_fallback(
  "item",
  "t1-pipe",
  { { "block-fluidbox-1" }, { "bob-steel-pipe", 3 }, { "pipe", 5 } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "t2-pipe",
  { { "block-fluidbox-1" }, { "bob-bronze-pipe", 3 }, { "pipe", 6 } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "t3-pipe",
  { { "block-fluidbox-2" }, { "bob-brass-pipe", 3 }, { "pipe", 7 } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "t4-pipe",
...
angelsmods.functions.RB.set_fallback(
  "item",
  "cell-2",
  { { "block-mprocessing-3", 3 }, { "angels-ore-floatation-cell" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "cell-3",
  { { "block-mprocessing-4", 3 }, { "angels-ore-floatation-cell-2" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "leach-2",
  { { "block-mprocessing-4", 3 }, { "angels-ore-leaching-plant" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "leach-3",
  { { "block-mprocessing-5", 3 }, { "angels-ore-leaching-plant-2" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "sorter-2",
  { { "block-production-2", 5 }, { "angels-ore-sorting-facility" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "sorter-3",
  { { "block-mprocessing-3", 5 }, { "angels-ore-sorting-facility-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "sorter-4",
  { { "block-mprocessing-4", 5 }, { "angels-ore-sorting-facility-3" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "sorter-5",
  { { "block-mprocessing-5", 5 }, { "angels-ore-sorting-facility-4" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "filter-3",
  { { "block-production-4", 3 }, { "angels-filtration-unit-2" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "salination-2",
  { { "block-production-4", 5 }, { "angels-salination-plant" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "gasrefsm-2",
  { { "block-cprocessing-3", 3 }, { "angels-gas-refinery-small" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "gasrefsm-3",
  { { "block-cprocessing-4", 3 }, { "angels-gas-refinery-small-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "gasrefsm-4",
  { { "block-cprocessing-5", 3 }, { "angels-gas-refinery-small-3" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "cracker-3",
  { { "block-cprocessing-4", 3 }, { "angels-steam-cracker-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "cracker-4",
  { { "block-cprocessing-5", 3 }, { "angels-steam-cracker-3" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "orepro-2",
  { { "block-mprocessing-3", 1 }, { "angels-ore-processing-machine" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "orepro-3",
...
angelsmods.functions.RB.set_fallback(
  "item",
  "pelletpre-3",
  { { "block-mprocessing-5", 1 }, { "angels-pellet-press-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "pelletpre-4",
  { { "block-mprocessing-5", 5 }, { "angels-pellet-press-3" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "powdermix-3",
  { { "block-mprocessing-4", 1 }, { "angels-powder-mixer-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "powdermix-4",
  { { "block-mprocessing-5", 1 }, { "angels-powder-mixer-3" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "blastfur-3",
  { { "block-mprocessing-3", 3 }, { "angels-blast-furnace-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "blastfur-4",
  { { "block-mprocessing-4", 3 }, { "angels-blast-furnace-3" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "indufur-2",
  { { "block-production-2", 3 }, { "angels-induction-furnace" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "indufur-3",
  { { "block-mprocessing-3", 3 }, { "angels-induction-furnace-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "indufur-4",
  { { "block-mprocessing-4", 3 }, { "angels-induction-furnace-3" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "castingm-2",
  { { "block-production-2", 1 }, { "angels-casting-machine" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "castingm-3",
  { { "block-mprocessing-3", 1 }, { "angels-casting-machine-2" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "castingm-4",
  { { "block-mprocessing-4", 1 }, { "angels-casting-machine-3" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "sinteringo-2",
  { { "block-production-2", 3 }, { "angels-sintering-oven" } }
)
angelsmods.functions.RB.set_fallback(
  "item",
  "sinteringo-3",
  { { "block-mprocessing-3", 3 }, { "angels-sintering-oven-2" } }
)
...
angelsmods.functions.RB.set_fallback(
  "item",
  "sinteringo-5",
  { { "block-mprocessing-5", 3 }, { "angels-sintering-oven-4" } }
)
