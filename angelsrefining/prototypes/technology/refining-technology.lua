...
--TIER -.5
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"slag-processing-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 2,
  prerequisites = {"ore-floatation", "water-washing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 64,
  prerequisites = {"ore-crushing", "water-treatment", "sulfur-processing"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"ore-crushing", "water-treatment", "automation-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 2,
  prerequisites = {"geode-processing-1", "slag-processing-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelsrefining__/graphics/technology/slag-processing.png",
  icon_size = 64,
  prerequisites = {"slag-processing-1", "ore-leaching"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"advanced-ore-refining-1"},
  effects = {{
    type = "unlock-recipe",
    recipe = "thermal-bore"
  }},
  ...
  icon = "__angelsrefining__/graphics/technology/thermal-extractor.png",
  icon_size = 128,
  prerequisites = {"thermal-water-extraction", "advanced-ore-refining-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon = "__angelsrefining__/graphics/technology/slag-processing.png",
  icon_size = 64,
  prerequisites = {"thermal-water-extraction", "slag-processing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 2,
  prerequisites = {"geode-processing-2", "slag-processing-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 128,
  prerequisites = {"ore-advanced-floatation", "geode-processing-3"},
  effects = {{
    type = "unlock-recipe",
