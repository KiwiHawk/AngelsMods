data:extend({{ -- collide just with object-layer and train-layer which don't collide with water, this allows us to build on 1 tile wide ground -- to test that tile directly under the pump is ground -- to prevent building on edge of map :(
  type = "item",
  name = "seafloor-pump",
