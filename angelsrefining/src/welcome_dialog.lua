...
function welcome_dialog:create_welcome_dialog(player_index)
  ...
  local pollutionSetting =
    game.map_settings.pollution.enabled and "enabled" or "disabled"
  welcomeFrameContent.add({
    type = "label",
  ...
  local enemySizeSetting =
    ((player.surface.map_gen_settings["autoplace_controls"] or {})["angels-biter-slider"] or {
      size = 0
  ...
  welcomeFrameContent.add({
    ...
    caption = {
      ...
      "     ",
      {
        "angels-welcome-message-settings.enemy-setting",
        {"angels-welcome-message-settings." .. enemySizeSetting}
      },
      " [img=info]"
    },
  ...
  local enemyEvolutionSetting =
    game.map_settings.enemy_evolution.enabled and "enabled" or "disabled"
  welcomeFrameContent.add({
    type = "label",
  ...
  local enemyExpansionSetting =
    game.map_settings.enemy_expansion.enabled and "enabled" or "disabled"
  welcomeFrameContent.add({
    type = "label",
