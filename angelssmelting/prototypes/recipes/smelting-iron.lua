...
-- CASTING RESULT -- l[angels-plate-iron]-a reserved for crushed saphirite smelting (see global overrides) -- l[angels-plate-iron]-b reserved for base game smelting recipe (see global overrides)
  type = "recipe",
