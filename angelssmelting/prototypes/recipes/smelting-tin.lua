...
-- CASTING RESULT -- i[angels-plate-tin]-a reserved for crushed bobmonium smelting (see tin overrides) -- i[angels-plate-tin]-b reserved for tin ore smelting (see tin overrides)
  type = "recipe",
