...
-- CASTING RESULT -- k[angels-plate-lead]-a reserved for crushed rubyte smelting (see lead overrides) -- k[angels-plate-lead]-b reserved for crushed rubyte smelting (see lead overrides)
  type = "recipe",
  ...
  icons = angelsmods.functions.create_liquid_recipe_icon(
    {
      {
        "__angelssmelting__/graphics/icons/molecule-hexafluorosilicic-acid.png",
        72
      }
    },
    "SiFF"
