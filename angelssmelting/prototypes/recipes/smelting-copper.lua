...
-- CASTING RESULT -- j[angels-plate-copper]-a reserved for crushed stiratite smelting (see global overrides) -- j[angels-plate-copper]-b reserved for base game smelting recipe (see global overrides) -- k[angels-wire-copper]-a reserved for base game recipe (see global overrides)
  type = "recipe",
