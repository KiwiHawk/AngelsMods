...
if data.raw.item["thorium-ore"] then
  ...
  data.raw.item["thorium-ore"].icon =
    "__angelssmelting__/graphics/icons/ore-thorium.png"
  ...
  data.raw.item["thorium-ore"].pictures = {{
    size = 64,
    filename = "__angelssmelting__/graphics/icons/ore-thorium.png",
    scale = 0.25,
    mipmap_count = 4
  }, {
    size = 64,
    filename = "__angelssmelting__/graphics/icons/ore-thorium-1.png",
    scale = 0.25,
    mipmap_count = 4
  }, {
    size = 64,
    filename = "__angelssmelting__/graphics/icons/ore-thorium-2.png",
    scale = 0.25,
    mipmap_count = 4
  }, {
    size = 64,
    filename = "__angelssmelting__/graphics/icons/ore-thorium-3.png",
    scale = 0.25,
    mipmap_count = 4
  }}
