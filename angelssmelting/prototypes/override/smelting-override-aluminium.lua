...
if angelsmods.trigger.smelting_products["aluminium"].ingot then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["alumina"].icon =
      "__angelssmelting__/graphics/icons/solid-aluminium-oxide.png"
  ...
  OV.patch_recipes({{
    ...
    ingredients = {{
      ...
      type = "item",
      name = mods["bobplates"] and "alumina" or "solid-aluminium-oxide",
      amount = 1
    }}
  }})
  ...
  if angelsmods.trigger.smelting_products["aluminium"].plate then
    ...
    do
      data.raw.technology["angels-aluminium-smelting-1"][property] =
        util.table.deepcopy(
          data.raw.technology["angels-aluminium-smelting-2"][property]
        )
    end
  end
else
...
if angelsmods.trigger.smelting_products["aluminium"].plate then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["aluminium-plate"].icon =
      "__angelssmelting__/graphics/icons/plate-aluminium.png"
