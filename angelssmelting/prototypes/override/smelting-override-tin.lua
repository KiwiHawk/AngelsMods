  ...
  if angelsmods.trigger.smelting_products["tin"].plate or angelsmods.trigger.smelting_products["tin"].wire then
    ...
    do
      data.raw.technology["angels-tin-smelting-1"][property] =
        util.table.deepcopy(
          data.raw.technology["angels-tin-smelting-2"][property]
        )
    end
  end
...
if angelsmods.trigger.smelting_products["tin"].plate then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["tin-plate"].icon =
      "__angelssmelting__/graphics/icons/plate-tin.png"
    ...
    OV.patch_recipes({{
      ...
      icons = {{icon = "__angelssmelting__/graphics/icons/plate-tin.png"}, {
...
if angelsmods.trigger.smelting_products["tin"].wire then
  ...
  if data.raw.item["tinned-copper-cable"] then -- bob electronics
    ...
    data.raw["item"]["tinned-copper-cable"].icon =
