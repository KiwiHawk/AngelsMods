...
if angelsmods.trigger.smelting_products["cobalt"].ingot then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["cobalt-oxide"].icon =
      "__angelssmelting__/graphics/icons/solid-cobalt-oxide.png"
  ...
  if angelsmods.trigger.smelting_products["cobalt"].plate then
    ...
    do
      data.raw.technology["angels-cobalt-smelting-1"][property] =
        util.table.deepcopy(
          data.raw.technology["angels-cobalt-smelting-2"][property]
        )
    end
  end
...
if angelsmods.trigger.smelting_products["cobalt"].plate then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["cobalt-plate"].icon =
      "__angelssmelting__/graphics/icons/plate-cobalt.png"
