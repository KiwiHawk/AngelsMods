...
if angelsmods.trigger.smelting_products["glass"].mixture then
  if angelsmods.trigger.smelting_products["glass"].plate or angelsmods.trigger.smelting_products["glass"].fibre or angelsmods.trigger.smelting_products["glass"].board then
...
if angelsmods.trigger.smelting_products["glass"].plate then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["glass"].icon =
      "__angelssmelting__/graphics/icons/plate-glass.png"
    ...
    OV.patch_recipes({{
      ...
      icons = {{icon = "__angelssmelting__/graphics/icons/plate-glass.png"}, {
