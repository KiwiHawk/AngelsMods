...
if angelsmods.trigger.smelting_products["tungsten"].powder then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["tungsten-oxide"].icon =
      "__angelssmelting__/graphics/icons/solid-tungsten-oxide.png"
    data.raw["item"]["tungsten-oxide"].icon_size = 32
    data.raw["item"]["tungsten-oxide"].icon_mipmaps = 1
    data.raw["item"]["tungsten-oxide"].localised_name =
      {"item-name.solid-tungsten-oxide"}
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["powdered-tungsten"].icon =
      "__angelssmelting__/graphics/icons/powder-tungsten.png"
    data.raw["item"]["powdered-tungsten"].icon_size = 64
    data.raw["item"]["powdered-tungsten"].icon_mipmaps = 4
    data.raw["item"]["powdered-tungsten"].localised_name =
      {"item-name.powder-tungsten"}
...
if angelsmods.trigger.smelting_products["tungsten"].plate then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["tungsten-plate"].icon =
      "__angelssmelting__/graphics/icons/plate-tungsten.png"
  ...
  if mods["angelsindustries"] and angelsmods.industries.tech then  -- not angels industry tech mode
  else
...
if mods["bobplates"] then
  local alloy_recipes =
    {"tungsten-carbide", "tungsten-carbide-2", "copper-tungsten-alloy"}
