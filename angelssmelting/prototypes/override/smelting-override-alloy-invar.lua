...
if angelsmods.trigger.smelting_products["invar"].plate then
  if mods["bobplates"] then
    ...
    --"angels-metallurgy-2",
      ...
      icon_size = 256,
      icon_mipmaps = 4,
      prerequisites = {"angels-steel-smelting-1", "angels-nickel-smelting-1"},
      effects = {{
        type = "unlock-recipe",
    ...
    angelsmods.functions.move_item(
      ...
      "d[invar]-b[invar-alloy]"
    )
    data.raw["item"]["invar-alloy"].icon =
      "__angelssmelting__/graphics/icons/plate-invar.png"
