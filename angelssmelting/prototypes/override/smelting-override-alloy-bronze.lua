...
if angelsmods.trigger.smelting_products["bronze"].plate then
  if mods["bobplates"] then
    ...
    --"angels-metallurgy-2",
      ...
      icon_size = 256,
      icon_mipmaps = 4,
      prerequisites = {"angels-tin-smelting-1", "angels-copper-smelting-1"},
      effects = {{
        type = "unlock-recipe",
      ...
      icon_size = 256,
      icon_mipmaps = 4,
      prerequisites = {"angels-bronze-smelting-1", "angels-nickel-smelting-1"},
      effects = {{
        type = "unlock-recipe",
    ...
    angelsmods.functions.move_item(
      ...
      "a[bronze]-b[bronze-alloy]"
    )
    data.raw["item"]["bronze-alloy"].icon =
      "__angelssmelting__/graphics/icons/plate-bronze.png"
