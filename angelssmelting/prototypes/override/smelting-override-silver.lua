...
if angelsmods.trigger.smelting_products["silver"].ingot then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["silver-nitrate"].icon =
      "__angelssmelting__/graphics/icons/solid-silver-nitrate.png"
  ...
  if mods["bobplates"] then
    ...
    data.raw.item["silver-oxide"].icon =
      "__angelssmelting__/graphics/icons/solid-silver-oxide.png"
  ...
  if angelsmods.trigger.smelting_products["silver"].plate or angelsmods.trigger.smelting_products["silver"].wire then
    ...
    do
      data.raw.technology["angels-silver-smelting-1"][property] =
        util.table.deepcopy(
          data.raw.technology["angels-silver-smelting-2"][property]
        )
    end
  end
else
...
if angelsmods.trigger.smelting_products["silver"].plate then
  ...
  if mods["bobplates"] then
    ...
    data.raw["item"]["silver-plate"].icon =
      "__angelssmelting__/graphics/icons/plate-silver.png"
    ...
    OV.patch_recipes({{
      ...
      icons = {{icon = "__angelssmelting__/graphics/icons/plate-silver.png"}, {
