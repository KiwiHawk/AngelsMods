...
if angelsmods.trigger.smelting_products["cobalt-steel"].plate then
  if mods["bobplates"] then
    ...
    --TECHS
      ...
      icon_size = 256,
      icon_mipmaps = 4,
      prerequisites = {"angels-steel-smelting-1", "angels-cobalt-smelting-1"},
      effects = {{
        type = "unlock-recipe",
    ...
    data.raw["item"]["cobalt-steel-alloy"].icon =
      "__angelssmelting__/graphics/icons/plate-cobalt-steel.png"
