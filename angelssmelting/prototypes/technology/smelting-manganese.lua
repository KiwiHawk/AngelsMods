...
--"angels-metallurgy-3",
  ...
  localised_description = {
    "technology-description.angels-manganese-metallurgy"
  },
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-1", "angels-manganese-smelting-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-2", "angels-manganese-casting-2"},
  effects = {{
    type = "unlock-recipe",
