...
--"angels-metallurgy-4",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"angels-metallurgy-2", "basic-chemistry-2"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-2", "angels-nickel-smelting-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-3", "angels-nickel-casting-2"},
  effects = {{
    type = "unlock-recipe",
