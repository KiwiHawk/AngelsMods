...
--"angels-metallurgy-5",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"ore-processing-3", "angels-chrome-smelting-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-3", "angels-chrome-smelting-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-4", "angels-chrome-casting-2"},
  effects = {{
    type = "unlock-recipe",
