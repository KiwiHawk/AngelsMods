...
--"angels-metallurgy-3",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"angels-metallurgy-1", "basic-chemistry"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-1", "angels-lead-smelting-1"},
  effects = {{
    type = "unlock-recipe",
  ...
  icon_size = 256,
  icon_mipmaps = 4,
  prerequisites = {"strand-casting-2", "angels-lead-casting-2"},
  effects = {{
    type = "unlock-recipe",
